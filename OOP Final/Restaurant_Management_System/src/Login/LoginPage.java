...
public class LoginPage extends ExceptionClass {
    ...
    LoginPage() {
        ...
        /**** Background ****/
        ImageIcon background_image = new ImageIcon("Restaurant_Management_System/src/Login/images/bg.jpg");
        ...
        login_button.setBounds(200,340,100,40);
        ...
        login_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                int flag= 0;
                try {
                    BufferedReader b = new BufferedReader(new FileReader("Restaurant_Management_System/src/Login/files/idPass.txt"));
...
//                            throw new ExceptionClass("ID does not exist, Please register yourself first!");                     }
    ...
    public static void remove(int ID) {
         try {
             ...
             File file = new File("Restaurant_Management_System/src/Login/files/idPass.txt");
             File tempFile = new File("Restaurant_Management_System/src/Login/files/temp.txt");
