...
public class Order2 extends ExceptionClass {
    ...
    public Order2() {
        ...
        /**** Background ****/
        ImageIcon background_image = new ImageIcon("Restaurant_Management_System/src/Order/images/orderImg.jpg");
        ...
        next.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int flag = 0;
                try {
                    FileWriter w = new FileWriter("Restaurant_Management_System/src/Order/files/Orders.txt", true);
                    BufferedReader b = new BufferedReader(new FileReader("Restaurant_Management_System/src/Order/files/menu.txt"));
                    FileWriter w2 = new FileWriter("Restaurant_Management_System/src/Order/files/latOrder.txt", true);
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    String filepath = "Restaurant_Management_System/src/Order/files/menu.txt";
