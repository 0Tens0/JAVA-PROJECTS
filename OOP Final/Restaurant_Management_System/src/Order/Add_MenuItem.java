...
class Add_MenuItem extends ExceptionClass {
    ...
    Add_MenuItem() {
        ...
        /**** Background ****/
        ImageIcon background_image= new ImageIcon("Restaurant_Management_System/src/Order/images/addItem.jpg");
		...
		try {
            ...
            FileWriter w = new FileWriter("Restaurant_Management_System/src/Order/files/menu.txt", true);
		    String str;
