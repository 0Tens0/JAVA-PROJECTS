...
public class Delete_MenuItem extends ExceptionClass {
    ...
    Delete_MenuItem() {
        ...
        /**** Background ****/
        ImageIcon background_image= new ImageIcon("Restaurant_Management_System/src/Order/images/delete.jpg");
        ...
        del.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
             ...
             try {
                 BufferedWriter tempWriter = new BufferedWriter(new FileWriter("Restaurant_Management_System/src/Order/files/temp.txt",false));
                 BufferedReader menuReader = new BufferedReader(new FileReader("Restaurant_Management_System/src/Order/files/menu.txt"));
                 ...
                 BufferedReader tempReader = new BufferedReader(new FileReader("Restaurant_Management_System/src/Order/files/temp.txt"));
                 BufferedWriter menuWriter = new BufferedWriter(new FileWriter("Restaurant_Management_System/src/Order/files/menu.txt"));
                 ...
                 File f=new File("Restaurant_Management_System/src/Order/files/temp.txt");
                 f.delete();
             }
